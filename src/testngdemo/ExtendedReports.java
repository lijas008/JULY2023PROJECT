...
public class ExtendedReports {
	...
	public void beftest() {
		// reporter=new
		// ExtentHtmlReporter(System.getProperty("user.dir")+"/reports/myreport.html");
	 ...
	 * 
	 * String destination="./Screenshot/"+screenshotname +".png"; //File
	 * finaldestination=new File(destination); //FileHandler.copy(src,
	 * finaldestination); FileHandler.copy(src, new File(destination));
	 * 
	 * return destination; }
	 */
